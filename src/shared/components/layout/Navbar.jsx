...
export default function Navbar() {
  ...
  return (
    <>
      <nav className={`z-50 w-full fixed top-0 left-0 border-b transition-all duration-500 ${
        isWaitlist 
          ? "bg-neutral-900/30 border-white/10 backdrop-blur-xl shadow-lg shadow-black/5" 
          : "bg-neutral-200 border-neutral-300 backdrop-blur-md"
      }`}>
        <div className="container">
          <div className="static flex py-4 items-center justify-between">
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-between">
              ...
              >
                <div className={`justify-center flex flex-col lg:flex-row p-4 lg:p-0 rounded-full transition-colors ${
                  isWaitlist ? "lg:bg-white/5" : "lg:bg-neutral-200"
                } max-lg:bg-white`}>
                  <div 
                  ...
                  >
                    <button
                      className={`inline-flex hover:bg-primary-500/[.04] rounded-full px-[18px] py-3 text-[14px] font-medium transition-all leading-[1.429] dropdown-toggle arrow-none ltr:text-left rtl:text-right max-lg:w-full justify-between items-center ${
                        isWaitlist ? "text-white" : "text-neutral-900"
                      }`}
                      type="button"
                      aria-haspopup="true"
                  ...
                  <a
                    href="#"
                    className={`inline-block hover:bg-primary-500/[.04] rounded-full px-[18px] lg:px-6 py-3 text-[14px] font-medium transition-all leading-[1.429] ${
                      isWaitlist ? "text-white" : "text-neutral-900"
                    }`}
                  >
                    Solutions
                  ...
                  >
                    <button
                      className={`inline-flex hover:bg-primary-500/[.04] rounded-full px-[18px] lg:px-6 py-3 text-[14px] font-medium transition-all leading-[1.429] dropdown-toggle arrow-none ltr:text-left rtl:text-right max-lg:w-full justify-between items-center ${
                        isWaitlist ? "text-white" : "text-neutral-900"
                      }`}
                      type="button"
                      aria-haspopup="true"
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className={`inline-flex items-center p-2 w-10 h-10 justify-center rounded-full lg:hidden focus:outline-none focus:ring-2 focus:ring-neutral-200 transition-colors ${
                  isWaitlist ? "text-white hover:bg-white/10" : "text-neutral-900 hover:bg-neutral-100"
                }`}
              >
