...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('DOMContentLoaded', () => {
    const openDropdown = document.querySelector('.drp-show [data-pc-toggle="dropdown"]');
    if (openDropdown) {
      const parent = openDropdown.parentNode;
      ...
      Popper.createPopper(openDropdown, dropdownMenu, {
        placement,
