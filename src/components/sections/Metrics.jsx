        ...
        <div className="container">
          <div className="flex flex-col sm:flex-row gap-3 items-stretch">
            <div className="basis-full sm:basis-1/2">
              <div className="animate-y delay-reset rounded-2xl sm:rounded-2xl md:rounded-2xl bg-neutral-100 overflow-hidden flex flex-col h-full">
                <div className="p-6 sm:p-6 md:p-6 flex flex-col items-start gap-4 sm:gap-4 h-full justify-between">
                  <div className="relative flex items-center justify-center">
                    <i className="ti ti-cloud-up text-[26px] sm:text-3xl leading-none absolute z-10 text-primary-500"></i>
                    {/* [ img starfab ] start */}
                    <svg
                      className="w-[60px] h-[60px] sm:w-[70px] sm:h-[70px] lg:w-[80px] lg:h-[80px] stroke-[2.90909]"
                      viewBox="0 0 84 84"
                      fill="none"
                    ...
                    >
                      ...
                      <defs>
                        ...
                        >
                          <stop stopColor="var(--secondary-100)" />
                          <stop offset="1" stopColor="var(--neutral-100)" />
                        </linearGradient>
                        <linearGradient
                          id="paint1_linear_5005_3474"
                          x1="84.8571"
                          y1="42.7143"
                          x2="-3"
                          y2="42.7143"
                          gradientUnits="userSpaceOnUse"
                        >
                          <stop stopColor="var(--neutral-100)" />
                          <stop offset="1" stopColor="var(--secondary-100)" />
                        </linearGradient>
                      </defs>
                    </svg>
                  </div>
                  <div className="flex flex-col gap-2 sm:gap-3">
                    ...
                    <h6 className="text-theme-text-secondary">
                      Track and monitor key performance indicators to measure
                      the effectiveness.
                    </h6>
                  </div>
                </div>
            ...
            <div className="basis-full sm:basis-1/2">
              <div className="animate-y p-4 lg:p-6 rounded-2xl sm:rounded-2xl md:rounded-2xl bg-neutral-100 overflow-hidden flex flex-col h-full">
                <div className="flex flex-col">
                  <div className="flex flex-row items-center py-3 sm:py-5 gap-2 lg:gap-3">
                    <div className="flex flex-col gap-2 w-full">
                      <h4 className="text-theme-text-secondary">
                        Employee Turnover Rate
                      </h4>
                      <div className="w-full bg-neutral-400 rounded-lg h-[6px]">
                        <div
                          className="bg-primary-500 h-full rounded-lg"
                          style={{ width: "15%" }}
                        ></div>
                      </div>
                    </div>
                    <div className="flex flex-row items-end">
                      <div className="h2">15</div>
                      <div className="h3 text-theme-text-secondary mb-0.5 md:mb-1">
                        %
                      </div>
                    </div>
                  </div>
