  ...
  useEffect(() => {
    const initSlider = () => {
      ...
      sliderInstance.current = window.tns({
        ...
        mouseDrag: true,
        responsive: {
          575: { items: 1, edgePadding: 100 },
          768: { items: 1, edgePadding: 100 },
          1000: { items: 2 },
          1266: { items: 2, edgePadding: 280 }
        }
      });

      if (prevBtnRef.current) {
        prevBtnRef.current.onclick = () => sliderInstance.current?.goTo('prev');
      }
      if (nextBtnRef.current) {
        nextBtnRef.current.onclick = () => sliderInstance.current?.goTo('next');
      }
    };
  ...
  return (
    <>
      <section className="common-section">
        <div className="flex flex-col gap-4 sm:gap-4 overflow-hidden">
          <div className="container">
            <div className="animate-y delay-reset flex flex-col items-center text-center gap-2 sm:gap-3">
              <h2>Trusted by Financial Institutions</h2>
              <h6 className="text-theme-text-secondary">
                See what banks, fintechs, and lending platforms say about building on Fincorex infrastructure.
              </h6>
            </div>
          </div>
          <div className="overflow-hidden animate-y delay-reset">
            <div className="flex flex-col gap-4 sm:gap-4" dir="ltr">
              <div className="testimonial-5-slider flex items-stretch" ref={sliderRef}>
                <div className="item group">
                  <div className="bg-neutral-100 rounded-2xl sm:rounded-2xl md:rounded-2xl overflow-hidden h-full">
                    <div className="flex flex-col h-full justify-between">
                      <div className="flex flex-col gap-3 p-6 lg:p-6 items-center text-center">
                        <svg
                          className="w-[84px] sm:w-[100px] md:w-[136px] h-[22px] sm:h-[25px] md:h-[38px] opacity-30"
                          viewBox="0 0 136 38"
                          fill="none"
                        ...
                        <h3 className="before:content-[open-quote] after:content-[close-quote]">
                          Fincorex CBA cut our core banking implementation time from 18 months to 6 weeks. The API documentation is world-class.
                        </h3>
                      </div>
                      <div className="p-4 sm:p-6 flex flex-row gap-2 sm:gap-3 bg-neutral-200 rounded-2xl sm:rounded-2xl md:rounded-2xl">
                        <div className="flex flex-col gap-3 justify-center items-center w-full text-center">
                          ...
                          <div className="flex gap-1 flex-col justify-center">
                            <h5>Adaeze Okafor</h5>
                            <div className="body2 text-theme-text-secondary">
                              CTO, Palmreach MFB
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="bg-neutral-100 rounded-2xl sm:rounded-2xl md:rounded-2xl overflow-hidden h-full">
                    <div className="flex flex-col h-full justify-between">
                      <div className="flex flex-col gap-3 p-6 lg:p-6 items-center text-center">
                        ...
                        <h3 className="before:content-[open-quote] after:content-[close-quote]">
                          CashRecova automated our collections overnight. NPL ratios dropped 34% in the first quarter.
                        </h3>
                      </div>
                      <div className="p-4 sm:p-6 flex flex-row gap-2 sm:gap-3 bg-neutral-200 rounded-2xl sm:rounded-2xl md:rounded-2xl">
                        <div className="flex flex-col gap-3 justify-center items-center w-full text-center">
                          ...
                          <div className="flex gap-1 flex-col justify-center">
                            <h5>Tunde Adeyemi</h5>
                            <div className="body2 text-theme-text-secondary">
                              Head of Credit, FinServe Credit
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="bg-neutral-100 rounded-2xl sm:rounded-2xl md:rounded-2xl overflow-hidden h-full">
                    <div className="flex flex-col h-full justify-between">
                      <div className="flex flex-col gap-3 p-6 lg:p-6 items-center text-center">
                        ...
                        <h3 className="before:content-[open-quote] after:content-[close-quote]">
                          Our sales have increased by 30% since we started using
                          this HRM. It’s an invaluable tool for our business.
                        </h3>
                      </div>
                      <div className="p-4 sm:p-6 flex flex-row gap-2 sm:gap-3 bg-neutral-200 rounded-2xl sm:rounded-2xl md:rounded-2xl">
                        <div className="flex flex-col gap-3 justify-center items-center w-full text-center">
                  ...
                  <div className="bg-neutral-100 rounded-2xl sm:rounded-2xl md:rounded-2xl overflow-hidden h-full">
                    <div className="flex flex-col h-full justify-between">
                      <div className="flex flex-col gap-3 p-6 lg:p-6 items-center text-center">
                        ...
                        <h3 className="before:content-[open-quote] after:content-[close-quote]">
                          Agentix gave us visibility into 8,000+ agents we never had before. Real-time dashboards changed how we manage our network entirely.
                        </h3>
                      </div>
                      <div className="p-4 sm:p-6 flex flex-row gap-2 sm:gap-3 bg-neutral-200 rounded-2xl sm:rounded-2xl md:rounded-2xl">
                        <div className="flex flex-col gap-3 justify-center items-center w-full text-center">
              ...
              <div className="block">
                <div className="flex flex-row items-end justify-center gap-3">
                  <button ref={prevBtnRef} className="slide-prev flex items-center justify-center hover:bg-black/[.04] dark:hover:bg-white/[.09] w-16 h-16 rounded-full border border-neutral-600">
                    <i className="ti ti-arrow-left text-primary-500 text-2xl leading-none"></i>
                  </button>
                  <button ref={nextBtnRef} className="slide-next flex items-center justify-center hover:bg-black/[.04] dark:hover:bg-white/[.09] w-16 h-16 rounded-full border border-neutral-600">
                    <i className="ti ti-arrow-right text-primary-500 text-2xl leading-none"></i>
                  </button>
                </div>
              </div>
            </div>
