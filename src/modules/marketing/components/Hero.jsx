...
import { fadeInUp, staggerContainer } from "@shared/constants/animations";
    ...
    <>
      <section className="relative overflow-hidden">
        <div className="absolute top-0 z-10 inset-x-0 block bg-neutral-100 h-[540px] sm:h-[738px] lg:h-[878px] overflow-hidden rounded-b-3xl sm:rounded-b-[32px] lg:rounded-b-[40px]">
          <div className="absolute inset-0 z-20 bg-[radial-gradient(47.33%_47.33%_at_50%_46.88%,_transparent_0%,_var(--neutral-500)_100%)]"></div>
        ...
        <div className="common-section relative z-20">
          <div className="container animation-ref mt-[100px]">
            <motion.div 
            ...
            >
              <div className="flex flex-col items-center gap-3">
                <motion.div variants={fadeInUp} className="py-1 px-2 text-theme-text-secondary caption rounded-full border border-theme-divider bg-white/50 backdrop-blur-sm">
