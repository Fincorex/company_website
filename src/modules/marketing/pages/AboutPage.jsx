    ...
    <div className="overflow-hidden">
      ...
      <section className="py-24 pattern text-white relative overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <motion.h2 initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="text-3xl md:text-5xl font-bold mb-6 text-gray-200">
              Our Approach
            </motion.h2>
          ...
          >
            {[
              ...
              <motion.div key={idx} variants={fadeInUp} className="bg-white/5 border border-white/10 p-8 rounded-[2rem] hover:bg-white/10 transition-colors backdrop-blur-sm">
                ...
                <h3 className="text-2xl font-bold mb-3 text-gray-200">{feature.title}</h3>
      ...
      <section className="py-15  pattern-grid relative overflow-hidden">
        ...
        <div className="container relative z-10 text-center text-white">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-extrabold mb-8 leading-tight text-gray-200">Ready to build the future of finance?</h2>
            <button className="bg-primary-300 text-black hover:bg-purple-400 hover:-translate-y-1 px-12 py-5 rounded-full font-bold text-xl transition-all duration-300 shadow-[0_0_40px_rgba(216,180,254,0.3)] hover:shadow-[0_0_60px_rgba(216,180,254,0.5)]">
              Partner With Us →
            </button>
          </motion.div>
        </div>
